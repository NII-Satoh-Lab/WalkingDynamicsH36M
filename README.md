...
WalkingDynamicsH36M is suitable for probabilistic mulitmodal future prediction. What is multimodality? The same past can generate different futures, differet so-called future modes. AN example: how futures from different tracks in the validation split can match the same past. 
![](/WalkingDynamicsH36M/images/wd36_multiple_futures.jpeg )

The trajectory from the test split is distributedhomogenously in space. 

![](/WalkingDynamicsH36M/images/Trajectory_test_sequences_centered_t_in_frames.png )
